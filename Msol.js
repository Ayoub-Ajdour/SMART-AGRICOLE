...
export default class Msol extends Component{

    constructor(props){
        super(props);
        this.state={listData:[],tSol:''};
        this.ambiListData()
    }
     ambiListData(){
    ...
    var i="http://10.0.2.2:80/api/mSol.php";
    fetch(i,
        {
            method:'POST',
            headers:headers,
    ...
    klikDelete(val){
           ...
           // alert(val);
            var urll="http:/10.0.2.2:80/api/supSol.php";
    ...
    InsertRecord=()=>
    {
        ...
        if(tSol.length==0 ){
          ...
          // alert("good");
            ...
            var InsertAPIURL="http:/10.0.2.2:80/api/insertSol.php";
            var headers={
                'Accept':'application/json',
                'Content-Type':'application.json'
            };
         ...
         return(
            ...
            >
                ...
                <Image source={require('./arrow.png')} style={syles.sizeImg3} />
                    ...
                    <Text style={syles.mater}>Sol</Text>

                </View>
                <View style={{height:100}}>
                    <TextInput  style={syles.TextInputWrapper} onChangeText={tSol=>this.setState({tSol})}/>
                </View>
                <View>
                ...
                <ScrollView bounces={false}
                  style= {syles.FlexOne}
                    ...
                    (
                        ...
                        <Text>     
                            <Text>        </Text>                
                                <TouchableOpacity   onPress={()=>this.klikDelete(val.id_sol)}>
