...
export default class Mdest extends Component{

    constructor(props){
        super(props);
        this.state={listData:[],tDest:''};
        this.ambiListData()
    }
     ambiListData(){
    ...
    var i="http://10.0.2.2:80/api/mdest.php";
    fetch(i,
        {
            method:'POST',
            headers:headers,
    ...
    klikDelete(val){
            ...
            var urll="http:/10.0.2.2:80/api/supdest.php";
    ...
    InsertRecord=()=>
    {
        ...
        if(tDest.length==0 ){
            ...
            var InsertAPIURL="http:/10.0.2.2:80/api/insertdest.php";
            var headers={
                'Accept':'application/json',
                'Content-Type':'application.json'
            };
         ...
         return(
            ...
            >
                ...
                <Image source={require('./arrow.png')} style={syles.sizeImg3} />
                    ...
                    <Text style={syles.mater}>Dest</Text>
                </View>
                <View style={{height:100}}>
                    <TextInput  style={syles.TextInputWrapper} onChangeText={tDest=>this.setState({tDest})}/>
                </View>
                <View>
                ...
                <ScrollView bounces={false}
                  style= {syles.FlexOne}
                    ...
                    (
                        ...
                        <Text>     
                            <Text>        </Text>                
                                <TouchableOpacity   onPress={()=>this.klikDelete(val.id_destruction_chimique)}>
                                <Image source={require('./bin.png')} style={syles.sizeImg2}/>
                                </TouchableOpacity>
                                <Text>        </Text>  
                <Text style={syles.textListName}>{val.nom_dest}</Text>
                </Text>
