...
export default class Mmalade extends Component{

    constructor(props){
        super(props);
        this.state={listData:[],tMald:'',mDesc:''};
        this.ambiListData()
    }
     ambiListData(){
    ...
    var i="http://10.0.2.2:80/api/mmalade.php";
    fetch(i,
        {
            method:'POST',
            headers:headers,
    ...
    klikDelete(val){
           ...
           // alert(val);
            var urll="http:/10.0.2.2:80/api/supMalade.php";
    ...
    InsertRecord=()=>
    {
        ...
        var tMald=this.state.tMald;
        var mDesc=this.state.mDesc;
        if(tMald.length==0||mDesc.length==0){
            alert("khawiya");
        }
        else{ 
          // alert("good");
            //props.navigation.navigate('nextMaterials')
            var InsertAPIURL="http:/10.0.2.2:80/api/insertMalade.php";
            var headers={
                'Accept':'application/json',
                'Content-Type':'application.json'
            };
         ...
         return(
            ...
            >
                ...
                <Image source={require('./arrow.png')} style={syles.sizeImg3} />
                    ...
                    <Text style={syles.mater}>Maladie</Text>
                </View>
                <View style={{height:300}}>
                    <TextInput  style={syles.TextInputWrapper} onChangeText={tMald=>this.setState({tMald})} placeholder='Nom'/>
                    <TextInput  style={syles.TextInputWrapperD} onChangeText={mDesc=>this.setState({mDesc})} placeholder='Description'/>
                </View>
                <View>
                ...
                <ScrollView bounces={false}
                  style= {syles.FlexOne}
                    ...
                    (
                        ...
                        <Text>     
                            <Text>        </Text>                
                                <TouchableOpacity   onPress={()=>this.klikDelete(val.id_maladie)}>
                                <Image source={require('./bin.png')} style={syles.sizeImg2}/>
                                </TouchableOpacity>
                                <Text>        </Text>  
                <Text style={syles.textListName}>{val.NomMaladie}</Text>
                </Text>
