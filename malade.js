...
import {ImageBackground,Alert,View,Text,StyleSheet,Image,Button,TouchableOpacity,TextInput, KeyboardAvoidingView, ScrollView, Platform } from 'react-native';
...
export default class malade extends Component{
    constructor(){
      ...
      /////////////////////////////////////////////////////////////////////////////////
    send=()=>{
       Valueb=this.state.selecdValueb;
  ...
  //  this.setState(this.send());  
       ...
       // alert(cin+id_ferme);
           var insertAPIURL="http://10.0.2.2:80/api/InsertMalad.php";
            var headers={
                'Accept':'application/json',
                'Content-type':'application.json'
            };
        ...
        return(
            ...
            >
             <ScrollView bounces={false}
                  style= {syles2.FlexOne}
                    >
                     ...
                     <View >
                         <Text style={syles2.R}>Maladie</Text>
                         </View>
             <View 
             ...
             >
               ...
               >
<       Picker.Item   label="Select Un Maladie" value="0"></Picker.Item>

{
                    ...
                    <Picker.Item   label={val.NomMaladie} value={val.id_maladie}  key={index}></Picker.Item>
                    ))
                }
                    </Picker>
