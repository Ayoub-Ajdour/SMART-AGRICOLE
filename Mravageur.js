...
export default class Mravageur extends Component{

    constructor(props){
        super(props);
        this.state={listData:[],tRavg:'',rDesc:''};
        this.ambiListData();
    }
     ambiListData(){
    ...
    klikDelete(val){
           ...
           // alert(val);
            var urll="http:/10.0.2.2:80/api/supRavgeur.php";
    ...
    InsertRecord=()=>
    {
        ...
        var tRavg=this.state.tRavg;
        var rDesc=this.state.rDesc;
        if(tRavg.length==0 ||rDesc.length==0){
            alert("khawiya");
        }
        else{ 
          // alert("good");
            //props.navigation.navigate('nextMaterials')
            var InsertAPIURL="http:/10.0.2.2:80/api/insertRavageur.php";
            var headers={
                'Accept':'application/json',
                'Content-Type':'application.json'
            };
         ...
         return(
            ...
            >
                ...
                <Image source={require('./arrow.png')} style={syles.sizeImg3} />
                    ...
                    <Text style={syles.mater}>Ravageur</Text>
                </View>
                <View style={{height:300}}>
                    <TextInput  style={syles.TextInputWrapper} onChangeText={tRavg=>this.setState({tRavg})} placeholder='Nom'/>
                    <TextInput  style={syles.TextInputWrapperD} onChangeText={rDesc=>this.setState({rDesc})} placeholder='Description'/>
                </View>
                <View>
                ...
                <ScrollView bounces={false}
                  style= {syles.FlexOne}
                    ...
                    (
                        ...
                        <Text>     
                            <Text>        </Text>                
                                <TouchableOpacity   onPress={()=>this.klikDelete(val.id_ravageur)}>
                                <Image source={require('./bin.png')} style={syles.sizeImg2}/>
                                </TouchableOpacity>
                                <Text>        </Text>  
                <Text style={syles.textListName}>{val.nom_ravageur}</Text>
                </Text>
