...
import {ImageBackground,View,Text,StyleSheet,Image,Alert,Button,TouchableOpacity,TextInput,KeyboardAvoidingView,ScrollView} from 'react-native';
...
export default class addMaterials extends Component{
    ...
    constructor(props){
        super(props);
        this.state={cin:'',id_ferme:'',Name:'',Type:'',Model:'',NumberPate:'',LastTechnicalInspection:'',LastInsurance:'',listData:[]  , vibrate: false,
        date1: new Date(),
        date2: new Date(),
    ...
    InsertRecord=()=>
    {
        ...
        var NumberPate=this.state.NumberPate;
       // var LastTechnicalInspection=this.state.LastTechnicalInspection;
        var LastInsurance=this.state.LastInsurance;
      ...
      //alert(this.state.id_ferme+'j');
      var id_ferme=this.state.id_ferme;
        if(Name.length==0 ||Type.length==0 ||Model.length==0 ||NumberPate.length==0 ){
            Alert.alert(
                "Materiel",
          ...
          // alert("good");
            ...
            var InsertAPIURL="http:/10.0.2.2:80/api/insertMat.php";
            var headers={
            ...
            var Data={
                ...
                Type:Type,
                Model:Model,
                NumberPate:NumberPate,
                LastTechnicalInspection:date1,
                LastInsurance:date2,
            };
            fetch(
                InsertAPIURL,
    ...
    render(){
        ...
        return(
           ...
           <Text style={{fontWeight:'700',color:'black',fontSize:20,top:8,left:10}}>Nom </Text>
            ...
            <TextInput placeholder="exemple" textAlign='center' onChangeText={Name=>this.setState({Name})}/>
            </View>
            <Text style={{fontWeight:'700',color:'black',fontSize:20,top:8,left:10}}>Type </Text>
            <View style={syles2.TextInputWrapper}>
            <TextInput placeholder="Type"  textAlign='center'  onChangeText={Type=>this.setState({Type})}/>
            </View>
            <Text style={{fontWeight:'700',color:'black',fontSize:20,top:8,left:10}}>Model </Text>
            <View style={syles2.TextInputWrapper}>
            <TextInput placeholder="Model"  textAlign='center'  onChangeText={Model=>this.setState({Model})}/>
            </View>
            <Text style={{fontWeight:'700',color:'black',fontSize:20,top:8,left:10}}>NumberPate </Text>
            <View style={syles2.TextInputWrapper}>
            <TextInput placeholder="NumberPate"  textAlign='center'  onChangeText={NumberPate=>this.setState({NumberPate})}/>
            </View>
