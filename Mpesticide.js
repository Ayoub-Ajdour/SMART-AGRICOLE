...
export default class Mpesticide extends Component{

    constructor(props){
        super(props);
        this.state={listData:[],tPest:'',rDesc:''};
        this.ambiListData();
    ...
    klikDelete(val){
            ...
            var urll="http:/10.0.2.2:80/api/supPest.php";
    ...
    InsertRecord=()=>
    {
        ...
        var tPest=this.state.tPest;
        var rDesc=this.state.rDesc;
        if(tPest.length==0 || rDesc.length==0){
            alert("khawiya");
        }
        else{ 
          // alert("good");
            //props.navigation.navigate('nextMaterials')
            var InsertAPIURL="http:/10.0.2.2:80/api/insertPest.php";
            var headers={
                'Accept':'application/json',
                'Content-Type':'application.json'
            };
         ...
         return(
            ...
            >
                ...
                <Image source={require('./arrow.png')} style={syles.sizeImg3} />
                    ...
                    <Text style={syles.mater}>Pesticide</Text>
                </View>
                <View style={{height:300}}>
                    <TextInput  style={syles.TextInputWrapper} onChangeText={tPest=>this.setState({tPest})} placeholder='Nom'/>
                ...
                <ScrollView bounces={false}
                  style= {syles.FlexOne}
                    ...
                    (
                        ...
                        <Text>     
                            <Text>        </Text>                
                                <TouchableOpacity   onPress={()=>this.klikDelete(val.id_pesticide)}>
                                <Image source={require('./bin.png')} style={syles.sizeImg2}/>
                                </TouchableOpacity>
                                <Text>        </Text>  
                <Text style={syles.textListName}>{val.type}</Text>
                </Text>
